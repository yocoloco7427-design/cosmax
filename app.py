...
.tt-card{
  background:var(--card); border-radius:24px; padding:20px 22px; margin-top:18px;
  box-shadow:0 10px 22px rgba(255,90,130,0.12); border:2px solid #fff;
}
.tt-card h4{ color:var(--pink-deep); margin-top:0; }
.tt-note{
...
# 입력 카드
# =========================================================
st.markdown('<div class="tt-card"><h4>💌 애정템을 골라주세요</h4>', unsafe_allow_html=True)
